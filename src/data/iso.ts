// Mapping from ISO 3166-1 numeric (used in world-atlas TopoJSON) to alpha-2
// Covers the subset we use for filtering. Anything not in the map renders as decorative-only.
export const NUMERIC_TO_ALPHA2: Record<string, string> = {
  '004': 'AF', '008': 'AL', '012': 'DZ', '024': 'AO', '028': 'AG', '032': 'AR', '036': 'AU',
  ...
  '528': 'NL', '533': 'AW', '540': 'NC', '548': 'VU', '554': 'NZ', '558': 'NI', '562': 'NE',
...
export const numToAlpha2 = (n: string | number): string | undefined => {
